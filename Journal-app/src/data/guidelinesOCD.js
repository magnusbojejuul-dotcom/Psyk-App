export const OCD_GUIDELINE = {
    ...
    algorithm: [
        {
            title: 'Mild OCD',
            summary: 'Kognitiv adfærdsterapi (KAT) med eksponering og responshindring er 1. valg. Evt. guidet selvhjælp.',
