export const GUIDELINE_ADVARSLER = [
    { type: 'critical', text: 'I.m.-olanzapin må aldrig kombineres med i.m.-benzodiazepin. Har man behov for at give i.m. lorazepam efter i.m. olanzapin, må det tidligst ske efter 1 time. Har man behov for at give i.m. olanzapin efter i.m. lorazepam, må det tidligst ske efter 2 timer.' },
    { type: 'warning', text: 'Behandling af ældre skal generelt varetages med forsigtighed. Doser skal som udgangspunkt være 1/4 eller 1/2 af voksendoser. Injektion olanzapin bør undgås til ældre med demens.' },
    { type: 'warning', text: 'Toksisk psykose (udløst af centralstimulantia) bør i den akutte fase ikke behandles med antipsykotika på grund af risiko for udvikling af kramper og malignt neuroleptikasyndrom. Behandles udelukkende med benzodiazepiner.' },
...
export const IV_BEHANDLING_VOKSNE = [
    ...
    { valg: '2', praeparat: 'I.v. haloperidol 0,5-2 mg', bemaerkning: 'Der anbefales et EKG før behandling. Obs. risiko for QTc-forlængelse.' }
];

export const DEMENS_BEHANDLING = [
    { valg: '1', praeparat: 'Risperidon (Lewy Body KONTRAINDICERET)', bemaerkning: 'Tbl./smeltetbl. startdosis: 0,25 mg til 1 mg dagligt, doser over 2 mg dagligt bør undgås. Indikation: Vedvarende aggression ved moderat til svær Alzheimers sygdom.' },
