...
export const CASE_CLINICAL_COMPARISONS = {
    ...
    normal_sinus: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'SA-knudens spontane pacemakerpotentiale styres af HCN4-kanaler (If "funny current"), der tillader langsom indstrømning af Na+ og K+ i hvilefasen, assisteret af T- og L-type Ca2+-kanaler (Cav1.2). Sympatisk aktivitet via β1-adrenoceptorer (Gs -> cAMP) øger If-stigningen og frekvensen, mens parasympatisk acetylkolin på M2-muskarine receptorer (Gi -> åbner IK,ACh) sænker fase 4 pacemakerstigningen. I ventrikelmyocytterne drives sammentrækningen af hurtige Nav1.5-natriumkanaler, mens balancen mellem Ca2+ (Cav1.2) og K+ (IKr/IKs) danner plateauet. Na+/K+-ATPasen pumper uafbrudt 3 Na+ ud for hver 2 K+ ind for at fastholde cellens negative indre på -90 mV via IK1.',
            actionPotentialEffect: 'I SA-knuden driver If en jævn fase 4 stigning mod tærskelpotentialet (-40 mV), hvor Cav1.2 udløser fase 0. I ventriklerne giver massiv Na+-influx en lynhurtig fase 0 stigning (dV/dt > 200 V/s) fra -90 mV til +30 mV. Fase 2 danner et stabilt isoelektrisk plateau i ca. 200 ms, før IKr og IKs driver fase 3 repolariseringen tilbage mod -90 mV, hvor IK1 låser hvilepotentialet.',
            ekgManifestation: 'SA-knudens depolarisering af atrierne danner P-takken (positiv i afledning II). Den fysiologiske forsinkelse i AV-knuden (hvor cellerne er små og afhængige af langsomme calciumkanaler frem for hurtige natriumkanaler) danner det flade PR-segment (120–200 ms), som sikrer fuld atrietømning. Purkinjefibrenes lynhurtige fase 0 holder QRS slankt (< 120 ms). Fordi epikardiet har flere Ito-kanaler, repolariseres epikardiet før endokardiet – denne omvendte repolariseringsrækkefølge gør, at T-takken fysiologisk vender samme vej som QRS-hovedudslaget!'
        },
    ...
    anterior_stemi: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Akut total okklusion af LAD lukker for ilt og glukose -> oxidativ fosforylering stopper, og cellulært ATP styrtdykker. Uden ATP svigter den elektrogene Na+/K+-ATPase: Na+ ophobes inde i cellen, og K+ siver ud i ekstracellulærvæsken. Samtidig åbner de metaboliske kaliumkanaler K_ATP (Kir6.2) som en direkte nødrespons på det faldende ATP/ADP-forhold, hvilket skaber en massiv patologisk kaliumudstrømning i infarktområdet. Den resulterende membran-depolarisering inaktiverer spændingsafhængigt de hurtige Nav1.5-kanaler i infarktzonen.',
            actionPotentialEffect: 'Det svigtende ionpumperi depolariserer de iskæmiske myocytters hvilemembranpotentiale fra normale -90 mV op til ca. -65 mV i diastolen (fase 4). I systolen bevirker de åbne K_ATP-kanaler, at aktionspotentialets fase 2 plateau kollapser og repolariseres ekstremt for tidligt i det syge forvægs-epikardium.',
            ekgManifestation: 'Dette skaber to komplementære skadestrømme, som tilsammen giver den massive "tombstone" ST-elevation i V1–V4: 1) Diastolisk skadestrøm: I hvilefasen er det syge væv relativt mere positivt (-65 mV) end det raske væv (-90 mV). Strøm flyder væk fra brystvægselektroderne, hvilket sænker TQ-grundlinjen (apparatet kompenserer automatisk ved at løfte ST-segmentet). 2) Systolisk skadestrøm: Under fase 2 er de syge forvægsceller repolariseret tidligere end det sunde væv (relativt negative), så strøm flyder fra sundt mod sygt væv – lige mod elektroderne V1–V4! Modstående afledninger (II, III, aVF) ser denne vektor fra modsat side -> reciprok ST-depression.'
        },
    ...
    inferior_stemi: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Akut trombose i RCA (eller LCx) berøver diafragmale venstre ventrikel og inferiore septum for ilt -> ATP-udtømning, lammelse af Na+/K+-ATPase og massiv åbning af epikardielle K_ATP-kanaler på hjertets underside. Hvis RCA-grenen til AV-knuden afficeres, svigter Cav1.2-kanalerne i AV-knuden. Samtidig udløser iskæmi i undervæggen Bezold-Jarisch refleksen: kardielle C-fibre aktiverer vagusnerven -> massiv acetylkolinudskillelse på muskarine M2-receptorer, som åbner IK,ACh-kanaler og hyperpolariserer sinus- og AV-knuden.',
            actionPotentialEffect: 'Cellerne på hjertets diafragmale flade mister deres negative fase 4 hvilepotentiale (-65 mV) og får forkortet fase 2/3 aktionspotentiale. I AV-knuden forlænges fase 0 opstigningstiden drastisk pga. kombineret iskæmisk calciummangel og vagal M2-hyperpolarisering.',
            ekgManifestation: 'Skadestrømsvektoren peger lige nedad mod fødderne, direkte mod elektroderne II, III og aVF, hvorved ST-segmentet løftes kraftigt op over grundlinjen. Afledning I og aVL på den høje laterale side ser vektoren bagfra -> dyb, skarp reciprok ST-depression i aVL (> 95% sensitivitet for RCA-okklusion). M2-vagusstormen og AV-nodal iskæmi forklarer den hyppige ledsagende sinusbradykardi og AV-blok.'
        },
    ...
    lbbb: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Venstre grenbundt er brudt pga. fibrose eller iskæmi. Depolariseringsbølgen kan ikke bruge venstre ventrikels lynhurtige Purkinjefibre, hvor Nav1.5-kanaler og gap junction proteiner (Connexin 40 og 43) leder med 2–4 m/s. Signalet må i stedet spredes asynkront udelukkende via arbejdskardiomyocytters gap junctions (Cx43), som kun leder med ca. 0.5 m/s (4–8 gange langsommere!).',
            actionPotentialEffect: 'Fase 0 depolariseringen i venstre ventrikel forsinkes med 40–70 ms. Septum depolariseres unormalt "baglæns" fra højre mod venstre via den intakte højre gren. Repolariseringssekvensen vendes om: venstre ventrikels myocytter depolariseres så sent, at repolariseringen starter endokardielt før epikardiet er færdigt.',
            ekgManifestation: 'Den omvendte transseptale spredning fjerner de normale fysiologiske septale q-takker i V5–V6. Den langsomme muskel-til-muskel ledning trækker QRS-komplekset ud over 120–150 ms. Den forsinkede venstre ventrikel danner en massiv vektor rettet mod venstre og bagud -> dyb bred QS-kløft i V1 og bred kærvet M-formet R-tak i laterale afledninger (I, aVL, V5, V6) – Hamptons "WiLLiaM"-mønster. Den omvendte repolariseringsrækkefølge skaber sekundære diskordante ST-depressioner og T-inversioner lateralt.'
        },
    ...
    rbbb: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Højre grenbundt er blokeret. Venstre ventrikels Purkinjesystem (Nav1.5) fungerer normalt, så venstre ventrikel og septum aktiveres helt fysiologisk. Herefter må aktiveringsbølgen imidlertid krybe langsomt transseptalt gennem myokardiet via gap junctions (Cx43, ~0.5 m/s) fra venstre mod højre for at aktivere den forsinkede højre ventrikel.',
            actionPotentialEffect: 'Fase 0 i venstre ventrikel forløber med normal høj hastighed (slanke 60–80 ms). Fase 0 i højre ventrikel starter først med 40–60 ms forsinkelse, efter at venstre ventrikel allerede har fuldført sin sammentrækning.',
            ekgManifestation: 'Første halvdel af QRS er normal: normal septal aktivering giver en slank lille r-tak i V1 og en slank q-tak i V6. Men anden halvdel domineres af den forsinkede højre ventrikel: da venstre ventrikel er færdig, findes der ingen modbalancerende venstresidige kræfter. Højre ventrikels sene depolarisering peger uimodsagt fremad mod V1 og væk fra laterale afledninger -> danner en sen, bred R\'-tak i V1 ("kaninører" / rsR\') og en bred, sløret S-tak i I, aVL og V6 – Hamptons "MaRRoW"-mønster.'
        },
    ...
    afib: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Elektrisk remodeling i forkamrene: Kardiomyocytternes L-type calciumkanaler (Cav1.2 / ICa,L) nedreguleres markant for at beskytte cellerne mod calcium-overload. Samtidig opreguleres indadrettede kaliumkanaler (Kir2.1 / IK1) samt en konstitutivt aktiv acetylkolinfølsom kaliumstrøm (IK,ACh), hvilket dræner cellerne for kalium i rekordfart.',
            actionPotentialEffect: 'Den øgede kaliumeffluks og svækkede calciumstrøm forkorter kardiomyocytternes fase 2 plateau og fase 3 repolarisering ekstremt. Den effektive refraktærperiode (ERP) falder drastisk. Bølgelængden for impulsen (hastighed x ERP) skrumper, så mange uafhængige mikro-reentry wavelets kan cirkulere samtidigt i forkamrene (frekvens 400–600/min).',
            ekgManifestation: 'Da der ikke findes én samlet depolarisationsbølge gennem atrierne, dannes ingen P-tak – kun en uregelmæssig flimrelinje (f-bølger). AV-knudens calciumkanaler bombarderes med 400–600 impulser/min. Pga. dekrementel ledning og skjult overledning (concealed conduction), hvor delvise impulser trænger ind i AV-knuden og forlænger dens refraktærtid uden at nå igennem, overledes kun vilkårlige impulser til His-bundtet -> arrhythmia absoluta.'
        },
    ...
    aflutter: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Et anatomisk afgrænset makro-reentry kredsløb i højre atrium. Impulsen løber op langs interatriale septum, henover atriets tag, ned langs den anterolaterale væg og tvinges gennem en snæver passage: den cavotrikuspidale isthmus (CTI) mellem tricuspidalklappen og vena cava inferior. Isthmus har færre gap junctions og høj modstand, hvilket bremser ledningshastigheden via Nav1.5.',
            actionPotentialEffect: 'Den langsomme ledning gennem isthmus giver vævet bagved tid til at restituere, så kredsløbet kører uafbrudt i ring med en fast cykluslængde på ca. 200 ms (frekvens nøjagtigt 300/min). Atriemyocytterne har ingen fase 4 hvileperiode, men gennemløber kontinuerligt fase 0-3 i én uendelig cyklus.',
            ekgManifestation: 'Fordi impulsen cirkulerer uafbrudt i en fast cirkel op ad septum og ned ad den frie væg, oscillerer dipolvektoren konstant væk fra bunden af hjertet. I afledningerne II, III og aVF dannes kontinuerlige negative savtakker (F-bølger) uden ét eneste millisekunds flad grundlinje! AV-knudens calciumkanaler (Cav1.2) har en refraktærperiode på ~350 ms og kan umuligt overlede 300 slag/min; hver anden impuls rammer knuden i dens absolutte refraktærfase -> 2:1 fysiologisk AV-blok med ventrikelpuls på præcis 150/min.'
        },
    ...
    vt: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Re-entry omkring myokardielt arvæv (hvor kollagenfibrose adskiller myocytter og nedsætter gap junction forbindelser via defosforyleret Cx43) eller "triggered activity" udløst af forsinkede efter-depolariseringer (DADs). DADs skyldes dysfunktionelle ryanodin-receptorer (RyR2), som lækker Ca2+ i diastolen; den elektrogene Na+/Ca2+-veksler (NCX) pumper 1 Ca2+ ud mod 3 Na+ ind, hvilket skaber en netto indadgående depolariserende strøm.',
            actionPotentialEffect: 'Når den indadgående Na+-strøm fra NCX når tærskelpotentialet i diastolen (fase 4), affyres et for tidligt ventrikulært aktionspotentiale. Signalet udbreder sig myocyt-til-myocyt i ventrikelvæggen uden om Purkinjesystemet, hvorved fase 0 opstigningshastigheden (dV/dt_max) reduceres kraftigt.',
            ekgManifestation: 'Den langsomme spredning gennem ventrikelmuskulaturen gør QRS-komplekserne ekstremt brede (> 120–160 ms) med abnorm akse. AV-dissociation: Sinusknudens If-pacemaker affyrer uforstyrret atriekontraktioner med 60–80/min, mens ventriklerne uafhængigt kører med 140–220/min. Sjældne "capture beats" (smalle QRS) eller "fusion beats" bekræfter den uafhængige atrioventrikulære aktivering.'
        },
    ...
    vf: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Massivt cellulært bølgebrud (wave break), hvor en organiseret ventrikelbølge splintres i utallige kaotiske mikro-spiralbølger ("rotorer"). Skyldes ekstrem heterogenitet i myokardiets refraktærtider pga. iskæmi, intracellulær acidose, uens inaktivering af Nav1.5-kanaler og regional ubalance i repolariserende kaliumstrømme (IKr, IKs, IK1).',
            actionPotentialEffect: 'Fuldstændig spatial og temporal desynkronisering: celler få mikrometer fra hinanden befinder sig samtidigt i fase 0, fase 2, fase 3 og fase 4. Myocytterne aktiveres asynkront med frekvenser på 300–500/min uden nogen fælles elektrisk bølgefront.',
            ekgManifestation: 'Da der ikke eksisterer nogen koordineret dipolvektor, forsvinder P-takker, QRS-komplekser og T-takker fuldstændigt. EKG-pennen registrerer kun uregelmæssige mikrosvingninger med svingende amplitude. Uden synkron elektrisk aktivering kan kardiomyocytterne ikke kontrahere ensartet – ventriklerne sitrer som en "pose orme", minutvolumen falder til 0, og patienten har akut hjertestop.'
        },
    ...
    long_qtc: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Lægemiddelmolekyler (antipsykotika som haloperidol og ziprasidon, antidepressiva som citalopram/escitalopram) kiler sig fysisk ind i porekaviteten på hERG/Kv11.1-kaliumkanalen (KCNH2). Kanalen medierer den hurtige forsinkede ensretter-kaliumstrøm IKr, som er kardiomyocyttens primære motor til at afslutte aktionspotentialet. Blokeringen forhindrer K+-ioner i at forlade cellen.',
            actionPotentialEffect: 'Manglen på udadrettet kaliumstrøm forlænger ventrikelmyocytternes fase 2 plateau og fase 3 repolarisering voldsomt -> aktionspotentialets varighed (APD) øges markant. Under dette unormalt lange plateau når L-type calciumkanaler (Cav1.2) at de-inaktivere og åbne igen, hvilket driver en ny Ca2+-influx og udløser tidlige efter-depolariseringer (Early Afterdepolarizations, EADs).',
            ekgManifestation: 'Ventriklernes forsinkede repolariseringstid ses direkte på EKG\'et som et forlænget tidsrum fra Q-start til T-slut (QTc > 500 ms). Når en EAD når tærskelpotentialet midt under T-takkens sårbare fase ("R-on-T fænomen"), udløses den maligne polymorfe ventrikeltakykardi Torsades de Pointes (TdP), hvor QRS-spidserne kontinuerligt vrider sig 180° om grundlinjen.'
        },
    ...
    hyperkalemia: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Ekstracellulær kaliumkoncentration stiger til > 6.0–7.5 mmol/L. Dette udløser to modsatrettede effekter: 1) Høj ydre kalium inducerer en paradoksal allosterisk konformationsændring i kaliumkanalerne hERG/IKr og Kir2.1/IK1, der øger deres åbningssandsynlighed og leder K+ ud med rekordfart. 2) Samtidig forskyder det ændrede kaliumforhold hvilemembranpotentialet mod et mere positivt niveau (Nernst-ligningen).',
            actionPotentialEffect: 'Hvilemembranpotentialet depolariseres fra normale -90 mV op til ca. -70 til -60 mV (fase 4). Dette delvist depolariserede niveau medfører massiv spændingsafhængig inaktivering af hurtige natriumkanaler (Nav1.5); deres inaktiveringsporte lukker og kan ikke genåbne. Fase 0 opstigningshastigheden (dV/dt_max) falder drastisk. Samtidig accelereres fase 3 repolariseringen voldsomt af den øgede IKr-konduktans.',
            ekgManifestation: '1) Den ultrahurtige fase 3 repolarisering danner de klassiske høje, symmetriske, nålespidse "teltformede" og teltede T-takker med smal basis. 2) Da atriemyocytterne er tynde og meget følsomme over for Nav1.5-inaktivering, lammes atrierne helt -> P-takken forsvinder (sinoventrikulær rytme). 3) I ventriklerne kryber strømmen langsomt -> QRS-komplekset breddeøges ekstremt og smelter sammen med T-takken i en præterminal sinusbølge. Behandling: Intravenøs Ca2+ (calciumgluconat) forskyder kardiomyocytternes tærskelpotentiale opad, så spændingsforskellen til hvilepotentialet genoprettes og membranerne stabiliseres mod asystoli.'
        },
    ...
    hypokalemia: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Ekstracellulær kaliumkoncentration falder til < 3.5 mmol/L (< 2.5 mmol/L er kritisk). Manglen på ekstracellulært K+ hæmmer konduktansen gennem kaliumkanalerne Kir2.1/IK1 og hERG/IKr. Samtidig hæmmes Na+/K+-ATPasen pga. mangel på ekstracellulært substrat-kalium.',
            actionPotentialEffect: 'Nedsat kaliumudstrømning i fase 3 forsinker ventrikelmyocytternes repolarisering voldsomt. Denne forlængelse er udtalt heterogen: de mid-myokardielle M-celler og Purkinjefibrene forlænges markant mere end det subepikardielle væv. Samtidig ophobes Na+, hvilket tvinger Na+/Ca2+-veksleren (NCX) til at køre i bakgear og pumpe Ca2+ ind i cellen -> intracellulær calciumoverload.',
            ekgManifestation: 'Den svækkede repolarisering afflader eller inverterer T-takken. Den store tidsforskel (transmurale dispersionsgradient) mellem epikardiet og de sene M-celler/Purkinjefibre genererer en prominent U-tak i V2–V4 umiddelbart efter T-takken (pseudoforlænget QU). Den intracellulære calciumophobning via NCX disponerer for forsinkede efter-depolariseringer (DADs) og ventrikulære arytmier.'
        },
    ...
    pericarditis: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Inflammationen i det viscerale perikardium spreder sig direkte til det underliggende subepikardielle cellelag af kardiomyocytter (subepikarditis). Den inflammatoriske kaskade kompromitterer epikardiecellernes cellemembraner og medfører lokal ion-lækage (svigt i at opretholde K+- og Na+-gradienter over membranen).',
            actionPotentialEffect: 'Diffus epikardiel forstyrrelse af kardiomyocytternes hvilemembranpotentiale (fase 4) og fase 2/3 repolarisering i det yderste tynde cellelag af både ventrikler og atrier. Myokardiets dybe arbejdsmuskulatur er intakt (normale QRS-komplekser og ingen patologiske Q-takker).',
            ekgManifestation: 'Membranskaden skaber en diffus epikardiel skadestrøm. Da perikarditissen dækker hele hjertesækken (modsat STEMI som rammer ét afgrænset kargebet), peger skadestrømmen udad mod samtlige overliggende elektroder (I, II, III, aVF, V2–V6) -> udbredte ST-elevationer. Fordi repolariseringen forsinkes mere jævnt end ved transmural anoksi, er elevationerne konkave opad ("hængekøje"-formede). Samtidig afficeres atriernes tynde epikardium: da atriernes repolariseringsvektor (Ta-bølge) peger modsat P-vektoren, forårsager atriel skadestrøm en karakteristisk PR-segment depression i næsten alle afledninger og reciprok PR-elevation i aVR.'
        },
    ...
    av_block_1: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Forsinket impulsledning gennem AV-knudens kompakte zone. AV-knudens celler er "slow-response" celler: de mangler hurtige Nav1.5-kanaler og er afhængige af spændingsafhængige L-type calciumkanaler (Cav1.2 / ICa,L). Høj vagustone frigiver acetylkolin på muskarine M2-receptorer (Gi -> hæmmer adenylatcyklase, lavere cAMP -> mindre PKA-fosforylering af Cav1.2) og åbner kaliumkanalen IK,ACh, hvilket hyperpolariserer AV-knudecellerne. Betablokkere hæmmer den fysiologiske sympatikuseffekt via β1-receptorer, og calciumantagonister forstærker denne hæmning.',
            actionPotentialEffect: 'Fase 0 opstigningshastigheden (dV/dt) i AV-knudens aktionspotentiale reduceres kraftigt. Det tager længere tid for hver enkelt celle at nå depolariseringstærsklen og sende signalet videre gennem de nodale fibre.',
            ekgManifestation: 'Tiden fra atriedepolariseringens start til ventrikelaktiveringen (impulsen passerer gennem atrierne, AV-knuden og His-bundtet) forlænges ud over den fysiologiske grænse på 200 ms (1 stort tern). PR-segmentet (den isoelektriske pause mellem P-slut og QRS-start) trækkes ud. Men da alle impulser overledes 1:1 uden udfald, er ventriklernes QRS-kompleks og T-tak fuldstændig normale.'
        },
    ...
    av_block_2_wenckebach: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Udtalt dekrementel ledning i AV-knudens L-type calciumkanaler (Cav1.2), kraftigt moduleret af høj vagustone på M2-muskarine receptorer. AV-knudecellernes calciumkanaler har langsom restitutionskinetik sammenlignet med natriumkanaler: det tager flere hundrede millisekunder for inaktiverede Cav1.2-kanaler at vende tilbage til den aktiverbare tilstand efter et aktionspotentiale.',
            actionPotentialEffect: 'Når en ny impuls ankommer fra sinusknuden, før AV-knudens calciumkanaler er fuldstændigt restituerede, overledes den med lavere calciumstrøm og lavere hastighed. Dette forsinker overledningen og forlænger knudens refraktærtid yderligere til næste slag. Forlængelsen stiger kumulativt, indtil en impuls rammer AV-knuden midt i den absolutte refraktærperiode -> Cav1.2-kanalerne er 100% inaktiverede, og impulsen blokeres totalt.',
            ekgManifestation: 'PR-intervallet forlænges gradvist for hvert hjerteslag, indtil en P-tak pludselig står alene uden efterfølgende QRS (udfald). I den efterfølgende pause restituerer calciumkanalerne fuldstændigt -> det næste PR-interval efter pausen er cyklussens allerkorteste, hvorefter sekvensen starter forfra (Wenckebach-periodicitet). R-R intervallerne bliver paradoksalt kortere op til udfaldet, fordi den relative stigning i PR er størst mellem slag 1 og 2!'
        },
    ...
    av_block_2_mobitz2: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Strukturel sygdom lokaliseret infranodalt (i His\' bundt eller distalt i grenbundterne), typisk forårsaget af svær diffus fibrose (Lenègre/Lev sygdom) eller forvægsinfarkt (LAD septalgrene). His-Purkinje celler er "fast-response" celler drevet af hurtige Nav1.5-kanaler.',
            actionPotentialEffect: 'I modsætning til AV-knudens gradvise calcium-dekrementelle forsinkelse arbejder His-Purkinje systemets natriumkanaler efter et alt-eller-intet princip: fase 0 depolariseringen er enten 100% normal, eller også ophører den fuldstændigt, hvis cellerne rammer en fibrotisk ledningsbarriere.',
            ekgManifestation: 'PR-intervallet for alle overledte slag er fuldstændigt konstant og uændret (ingen forudgående forlængelse som ved Wenckebach). Pludseligt svigter impulsen i det beskadigede His-Purkinje væv -> et eller flere QRS-komplekser falder brat ud. Da blokeringen sidder dybt i grenene, er det ledsagende QRS-kompleks næsten altid bredt (grenblok). Tilstanden er mekanisk ustabil med overhængende risiko for akut totalt ledningsstop (Adams-Stokes asystoli), hvilket kræver akut pacemaker (PPM).'
        },
    ...
    av_block_3: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Komplet anatomisk eller funktionel afbrydelse af impulsoverledningen mellem atrier og ventrikler (enten massiv nekrose/fibrose i AV-knuden eller bilateralt grenblok). Atriernes signal kan under ingen omstændigheder nå ventriklerne. Ventrikelmyocytterne reddes udelukkende af en subsidiar pacemaker, hvor spontan fase 4 depolarisering drives af langsomme HCN-kanaler (If) og den elektrogene Na+/Ca2+-veksler (NCX).',
            actionPotentialEffect: 'Atrierne drives ufortrødent af SA-knudens spontane fase 4 depolarisering med normal frekvens (60–90/min). Ventriklerne modtager intet overordnet signal, men overtages af det hurtigste tilbageværende fokus: 1) Junctionalt/His-fokus: smalle aktionspotentialer, frekvens 40–50/min. 2) Idioventrikulært fokus i Purkinjefibre: langsom fase 4 opstigning, frekvens 20–35/min.',
            ekgManifestation: 'Fuldstændig AV-dissociation: P-takkerne marcherer regelmæssigt over strimlen med deres egen hurtigere frekvens (P-P intervaller faste) og falder tilfældigt før, midt i eller oven i QRS og T. QRS-komplekserne marcherer uafhængigt med deres egen langsomme, faste rytme (R-R faste). Hvis fokus er junctionalt, er QRS smalt (< 120 ms); hvis fokus er idioventrikulært, spredes impulsen langsomt muskel-til-muskel -> brede, klodsede QRS-komplekser (> 140 ms), svær bradykardi og hæmodynamisk kollaps.'
        },
    ...
    lvh: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Kronisk trykoverbelastning (arteriel hypertension, aortastenose) udsætter kardiomyocytterne for mekanisk stræk, der aktiverer membranbundne AT1-angiotensinreceptorer, α1-adrenerge receptorer og endotelin-receptorer -> intracellulær MAPK/ERK-kaskade og kardiomyocyt-hypertrofi. Myocytterne vokser i bredden: der dannes flere parallelle myofibriller, cellemembranens areal øges drastisk, og antallet af fungerende Nav1.5-natriumkanaler og Cav1.2-calciumkanaler pr. ventrikelvolumen mangedobles.',
            actionPotentialEffect: 'Den kolossale stigning i mængden af membran- og natriumkanaler genererer en langt kraftigere samlet fase 0 depolariseringsstrøm. Samtidig forsinkes den transmurale udbredelse af fase 0 gennem den fortykkede muskelvæg (intrinsikoid afbøjningstid forlænges > 50 ms i V5–V6). I systolen overstiger det intramurale tryk koronarperfusionstrykket, hvilket giver relativ subendokardial iskæmi og forsinket endokardiel repolarisering.',
            ekgManifestation: '1) Den øgede myocytmasse genererer en kæmpe depolarisationsdipol rettet bagud og mod venstre -> enorme R-takker i de laterale afledninger (V5, V6, I, aVL) og dybe reciprokke S-takker mod højre forvæg (V1, V2), så Sokolow-Lyon kriteriet (S_V1 + R_V5/V6 >= 35 mm) opfyldes. 2) Den relative subendokardielle iskæmi og forstyrrede repolariseringssekvens danner det klassiske venstresidige strain-mønster: asymmetrisk, nedadbuende ST-depression efterfulgt af inverterede, asymmetriske T-takker i lateralafledningerne (I, aVL, V5, V6).'
        },
    ...
    posterior_stemi: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'Akut trombotisk okklusion af arteria circumflexa (LCx) eller en posterolateral gren fra RCA lukker for blodforsyningen til venstre ventrikels posterobasale bagvæg. Mangel på ilt stopper ATP-produktionen, slår Na+/K+-ATPasen ud og åbner metaboliske K_ATP-kanaler i det posteriore epikardium.',
            actionPotentialEffect: 'De posteriore kardiomyocytter mister deres -90 mV hvilepotentiale og depolariserer til -65 mV i diastolen (fase 4). I systolen forkorter K_ATP-kaliumeffluksen fase 2 plateauet i bagvæggens epikardium.',
            ekgManifestation: 'Den transmurale skadestrømsvektor peger dorsalt (bagud mod ryggen). Da elektroderne V1–V3 sidder anteriort på forreste brystkasse, kigger de ind i bagsiden af skadestrømmen (det optiske spejlbillede): 1) Den posteriore ST-elevation ses forfra som en horisontal ST-depression i V1–V3. 2) Det posteriore celletab ses forfra som en høj, bred R-tak (R/S > 1) i V1–V2. 3) Den posteriore T-inversion ses forfra som en høj opretstående T-tak i V1–V3. Vend EKG\'et på hovedet mod lyset for at se infarktet, eller påsæt dorsale afledninger V7–V9 på ryggen mhp. direkte ST-elevation >= 0.5 mm.'
        },
    ...
    pulmonary_embolism: {
        ...
        cellularElectrophysiology: {
            molecularMechanism: 'En tromboembolus kiler sig fast i lungearterietræet og øger akut den pulmonale karmodstand. Højre ventrikel, hvis tynde muskelvæg (3–4 mm) er bygget til lavtrykskredsløb, udsættes for en brutal afterload-stigning og dilaterer akut. Trykfald og hypoksi udløser massiv neurohumoral sympatikusaktivering: noradrenalin og adrenalin stimulerer β1-adrenerge receptorer i sinusknuden via Gs -> cAMP -> øget If-kanalaktivitet.',
            actionPotentialEffect: 'Det tårnhøje vægstress i den udspændte højre ventrikel overstiger kapillærtrykket, hvilket udløser akut iskæmi i højre ventrikels myocytter. Iskæmien forsinker fase 2 plateau og fase 3 repolarisering i hele højre ventrikelvæg.',
            ekgManifestation: '1) Sinustakykardi: Sympatikusaktivering af β1 og If øger pulsen til > 100/min (> 90% af tilfælde). 2) Akut akserotation og S1Q3T3 (McGinn-White mønster): Den akut dilaterede højre ventrikel presser septum mod venstre og roterer hjertet med uret -> dyb S-tak i afledning I, patologisk Q i III og inverteret T i III. 3) T-taks inversion i V1–V4: Den akutte iskæmiske overbelastning af højre ventrikel medfører udbredte, symmetriske T-taks inversioner i de højresidige brystafledninger V1–V4 (akut cor pulmonale).'
        },
