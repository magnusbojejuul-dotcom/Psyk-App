export const ANOREXIA_OPTIONS = [
    ...
    { id: 'an_fluid_type', label: 'Hvad drikkes?', category: 'Spiseadfærd & Mønstre', text: 'Væsketype:', hasInput: true, inputPlaceholder: 'Vand, sodavand m.v.' },
    ...
    { id: 'an_comp_exercise', label: 'Motion', category: 'Kompenserende Adfærd', text: 'Udfører kompenserende motion.', smartMerge: { prefix: 'Af kompenserende adfærd benyttes ', item: 'kompenserende motion', suffix: '.' } },
    ...
    { id: 'an_comp_prevent', label: 'Hvis forhindret?', category: 'Kompenserende Adfærd', text: 'Ved forhindring af kompenserende adfærd ses:', hasInput: true, inputPlaceholder: 'Angst, uro m.v.' },
    { id: 'an_ord_standard', label: 'Ingen aktuelle kosttilskud', category: 'Standard Ordinationer', text: 'Patienten får ikke kosttilskud. Der ordineres:\nMEDICIN:\nRp. Tbl. Multivitamin 1 stk x 1 dgl.\nRp. Tbl. Thiamin 300 mg x 1 dgl. i 3 uger (før første måltid).\nRp. Tbl. Unikalk 1 stk x 2 dgl.' },
    { id: 'an_ord_thiamin_chronic', label: 'Kronisk patient (Thiamin)', category: 'Standard Ordinationer', text: 'Rp. Tbl. Thiamin 300 mg x 1 dgl. (før første måltid).' },
    { id: 'an_ord_bcombin', label: 'B-combin tillæg', category: 'Standard Ordinationer', text: 'Rp. Tbl. B-combin 1 stk x 3 dgl.' },
];
