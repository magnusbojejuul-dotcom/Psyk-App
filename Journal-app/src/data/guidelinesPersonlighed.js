export const BORDERLINE_GUIDELINE = {
    ...
    algorithm: [
        ...
        },
        {
            ...
            summary: 'Udarbejdelse af individuel kriseplan med konkrete handlemuligheder. Obligatorisk ved selvmordsrisiko.',
        ...
        },
        {
            ...
            summary: 'Svag anbefaling IMOD rutinemæssig brug af psykofarmaka for selve personlighedsforstyrrelsen (off-label).',
