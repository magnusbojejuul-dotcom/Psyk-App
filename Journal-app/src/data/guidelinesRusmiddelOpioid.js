export const RUSMIDDEL_OPIOID = {
    ...
    toxication: {
        ...
        symptoms: [
            { name: 'Miosis (Knappenålspupiller)', icon: 'eye', desc: 'Stærkt forsnævrede pupiller (bortset fra ved blanding med f.eks. kokain/amfetamin eller svær hypoksi).' },
