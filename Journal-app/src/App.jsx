            ...
            <header className="glass-panel border-b-0 px-6 py-3 flex justify-between items-center shadow-sm shrink-0 z-20">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1.5 text-xs text-[#839788]/80"><span>Klinisk dokumentationsstøtte</span><span className="text-[#E8E4D9]">•</span><span>v10.2 (Light Theme)</span></div>
                    </div>
                    <GdprBanner />
                </div>
