 ...
 * 
 * Bruger det originale, publicerede medicinske illustrationsunderlag fra
 * The Physiological Society ("Trigonometry of the ECG"), hvorpå interaktive
 * vektorprojektioner, afledningsvalg, aksekvadranter og realtids-dipol projiceres.
 */
export default function EkgHeartModel({ selectedLead = 'II', onSelectLead, caseData, activeCase: propActiveCase }) {
    ...
    const [cycleTime, setCycleTime] = useState(230); // Starter stabilt på hovedsystolen (R-takken)
    ...
    const CABRERA_LEADS = [
        { name: 'I', angle: 0, tipX: 175, tipY: 0, labelX: 205, labelY: 5 },
        { name: 'II', angle: 60, tipX: 87.5, tipY: 151.5, labelX: 110, labelY: 195 },
        { name: 'aVF', angle: 90, tipX: 0, tipY: 175, labelX: 0, labelY: 220 },
        { name: 'III', angle: 120, tipX: -87.5, tipY: 151.5, labelX: -110, labelY: 195 },
        { name: 'aVR', angle: -150, tipX: -151.5, tipY: -87.5, labelX: -195, labelY: -100 },
        { name: 'aVL', angle: -30, tipX: 151.5, tipY: -87.5, labelX: 195, labelY: -100 }
    ];
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-6 w-full max-w-[1400px] mx-auto">
            ...
            <div className="flex-1 glass-panel rounded-3xl p-5 md:p-6 border border-[#E8E4D9] flex flex-col shadow-sm bg-white/95">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-[#E8E4D9]">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[#839788]">The Physiological Society standard • Interaktiv 12-afledningsprojektion</p>
                        </div>
                    </div>
                ...
                {/* DET CENTRALE MODELOMRÅDE (SVG MED ÆGTE ILLUSTRATION OG INTERAKTIVE LAG) */}
                <div className="relative w-full h-[450px] sm:h-[520px] my-3 flex items-center justify-center bg-white rounded-3xl overflow-hidden border-2 border-[#E2E8F0] shadow-inner">
                    {viewMode === 'frontal' ? (
                        /* FRONTALPLAN SVG: ÆGTE MEDICINSK ILLUSTRATION MED INTERAKTIV VEKTOR-OVERLAY */
                        <svg viewBox="-260 -260 520 520" className="w-full h-full max-h-[520px] select-none">
                            <defs>
                            ...
                            {showAxisSectors && (
                                <g id="axisSectors" opacity="0.35">
                                    ...
                                    {/* Ekstrem Akseafvigelse: -90° til -180° (Gul) */}
                            ...
                            {CABRERA_LEADS.map(lead => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Hvis valgt: fremhæv pilen med en lysende rød linje og cirkel */}
                                        {isSel && (
                                            <>
                                                <line
                                                    x1="0"
                                        ...
                                        {/* Usynlig bred klik-target over hele vektoren */}
                                        <line
                                            x1="0"
                                            y1="0"
                                            x2={lead.tipX}
                            ...
                            {showVector && currentPhase.vector.magnitude > 0.05 && (() => {
                                ...
                                return (
                                    <g id="liveVectorGroup">
                                        {/* Stiplet vinkelret projektionslinje ned på den valgte afledning */}
                                        <line
                                            x1={vx}
                                            y1={vy}
                                            x2={px}
                                        ...
                                        {/* Nydelig fasebadge ved vektorspidsen */}
                                        <g transform={`translate(${vx > 20 ? vx - 85 : vx + 10}, ${vy > 20 ? vy - 10 : vy + 15})`}>
                                            <rect x="0" y="0" width="88" height="22" rx="6" fill="#0F172A" fillOpacity="0.92" stroke={currentPhase.vector.color} strokeWidth="1.2" />
                                            <text x="44" y="15" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#FFFFFF">
                        ...
                        <svg viewBox="-240 -240 480 480" className="w-full h-full max-h-[520px] select-none">
                            <defs>
